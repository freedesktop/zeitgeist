...
class ValaSerializer(RecursiveSerializer):
	...
	def serialize(self, stream, base=None, encoding=None, **args):
		...
		for symbol in sorted(symbol_classes):
			self._create_symbol(
				stream, symbol, symbol_classes.union(set([NIENS["InformationElement"], NIENS["DataObject"]]), root_dict)
			)
