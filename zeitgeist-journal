...
from zeitgeist.gui.zeitgeist_journal_widgets import *
...
class Journal(gtk.Window):
	...
	def __init__(self):
		...
		journal = "%s/calendar.svg" % config.pkgdatadir
	...
	def _create_toolbar_buttons(self):
		...
		pixbuf = gtk.gdk.pixbuf_new_from_file_at_size("%s/bookmark-new.svg" % config.pkgdatadir, 24, 24)
